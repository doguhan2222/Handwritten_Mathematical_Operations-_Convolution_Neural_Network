...
class OurCnnModel:
    ...
    def our_model(self, input_shape=(32, 32, 1)):
        ...
        model.add(Dense(120, activation='relu', kernel_initializer=keras.initializers.glorot_uniform(seed=0), name='fc1'))
        model.add(Dense(84, activation='relu', kernel_initializer=keras.initializers.glorot_uniform(seed=0), name='fc2'))
        model.add(Dense(16, activation='softmax', kernel_initializer=keras.initializers.glorot_uniform(seed=0), name='fc3'))
    ...
    def training_model(self, model):
        ...
        hist = model.fit(aug.flow(self.X_train, self.Y_train, batch_size=128), batch_size=128, epochs=100,
    ...
    def saving_model(self, model):
        model.save('saved_model/our_model_ann_hw.h5')
